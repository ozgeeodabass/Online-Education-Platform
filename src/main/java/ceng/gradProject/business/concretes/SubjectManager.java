...
public class SubjectManager implements SubjectService {
	...
	public DataResult<List<Subject>> getAll() {
		...
		for (Subject subject : subjects) {
			...
			responseItem.setCourses(subject.getCourses());
	...
	public DataResult<Subject> getBySubjectId(int id) {
		Subject subjectFind = subjectRepository.findById(id).get();
		
		return new SuccessDataResult<Subject>(subjectFind, "Konu Listelendi");
	}
